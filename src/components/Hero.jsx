        ...
        <div className="md:w-1/3 p-4 space-y-24 text-center md:text-left">
          ...
          <div className="flex items-center flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0 ">
            <LinkButton
              text="Our Courses"
              link="#"
              className="btn overflow-hidden relative w-64 bg-blue-500 text-white text-center  py-2 px-2 rounded-xl font-medium uppercase -- before:block before:absolute before:h-full before:w-1/2 before:rounded-full before:bg-orange-400 before:top-0 before:left-1/4 before:transition-transform before:opacity-0 before:hover:opacity-100 hover:text-orange-200 hover:before:animate-ping transition-all duration-300"
            />
            <LinkButton
              text="Corporate Solutions"
              link="#"
              className="btn-default overflow-hidden relative w-64 text-gray-900 text-center py-2 px-4 rounded-xl font-medium uppercase transition-all duration-100 -- hover:shadow-md border border-stone-100 hover:bg-gradient-to-t hover:from-stone-100 before:to-stone-50 hover:-translate-y-[3px]"
            />

            {/*
              <button className="btn overflow-hidden relative w-64 bg-blue-500 text-white py-2 px-2 rounded-xl font-medium uppercase -- before:block before:absolute before:h-full before:w-1/2 before:rounded-full before:bg-orange-400 before:top-0 before:left-1/4 before:transition-transform before:opacity-0 before:hover:opacity-100 hover:text-orange-200 hover:before:animate-ping transition-all duration-300">
              <span className="relative">Our Courses</span>
            </button>
            <button className="btn-default overflow-hidden relative w-64 text-gray-900 py-2 px-4 rounded-xl font-medium uppercase transition-all duration-100 -- hover:shadow-md border border-stone-100 hover:bg-gradient-to-t hover:from-stone-100 before:to-stone-50 hover:-translate-y-[3px]">
